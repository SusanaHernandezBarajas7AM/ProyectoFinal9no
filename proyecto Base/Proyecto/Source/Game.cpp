...
void CGame::CargandoObjetos()
{
	...
	textoOpcion2Sel = new Sprite(&openGlImplement, "Texto_Opcion2Sel", 0, 0); //2 y 80 MiNave
...
void CGame::JugandoPintar(){
	...
	//jugandoFondo->TranslateXY(translate_jugando_x--, 0.f);
	//if (translate_jugando_x < -1024)
	//	translate_jugando_x = 0.f;

	//////velociadad del movimiento 
	//  movimiento_jugando_x -= 4;
	////// aqui en fondo se mueve en x 
	//  jugandoFondo->TranslateXY(movimiento_jugando_x--, 0.f);
	//   //	//aqui es para que se regrese 
	//   if (translate_jugando_x < -1024) //1280
	//    
	////// y regresa a 0 si si es cierto en el if 
	//movimiento_jugando_x = 0.f;
	////////////////////////////////////////
...
//<<<<<<< .mine
    textoNombre->ScaleXYZ(10.f,10.f,10.f); //modificamos para que se viera mas grande
    textoNombre->RotateXYZ(1.f, 0.f, 0.f); // la rotacion del cubo
//=======
//>>>>>>> .r9
	textoNombre->Draw();
